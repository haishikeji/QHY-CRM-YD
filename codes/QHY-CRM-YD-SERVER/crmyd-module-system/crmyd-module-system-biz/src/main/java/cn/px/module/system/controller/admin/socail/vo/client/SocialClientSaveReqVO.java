package cn.px.module.system.controller.admin.socail.vo.client;

import cn.hutool.core.util.StrUtil;
import cn.px.framework.common.enums.CommonStatusEnum;
import cn.px.framework.common.enums.UserTypeEnum;
import cn.px.framework.common.validation.InEnum;
import cn.px.module.system.enums.social.SocialTypeEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "crmyd商城")
