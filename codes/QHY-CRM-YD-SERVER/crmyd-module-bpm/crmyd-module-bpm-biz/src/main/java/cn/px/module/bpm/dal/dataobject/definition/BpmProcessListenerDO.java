package cn.px.module.bpm.dal.dataobject.definition;
...
public class BpmProcessListenerDO extends BaseDO {
     ...
     * 状态
     *
     * 枚举 {@link cn.px.framework.common.enums.CommonStatusEnum}
     */
    private Integer status;
    /**
     * 监听类型
     *
     * 枚举 {@link cn.px.module.bpm.enums.definition.BpmProcessListenerType}
     *
