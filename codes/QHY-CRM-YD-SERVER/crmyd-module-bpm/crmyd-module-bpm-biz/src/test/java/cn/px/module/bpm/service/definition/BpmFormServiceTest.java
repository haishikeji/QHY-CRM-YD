package cn.px.module.bpm.service.definition;

import cn.hutool.core.util.RandomUtil;
import cn.px.framework.common.pojo.PageResult;
import cn.px.framework.common.util.json.JsonUtils;
import cn.px.framework.test.core.ut.BaseDbUnitTest;
import cn.px.module.bpm.controller.admin.definition.vo.form.BpmFormSaveReqVO;
...
import cn.px.module.bpm.dal.mysql.definition.BpmFormMapper;
import cn.px.module.bpm.service.definition.dto.BpmFormFieldRespDTO;
...
import static cn.px.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.px.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.px.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.px.framework.test.core.util.RandomUtils.randomLongId;
import static cn.px.framework.test.core.util.RandomUtils.randomPojo;
import static cn.px.module.bpm.enums.ErrorCodeConstants.FORM_NOT_EXISTS;
