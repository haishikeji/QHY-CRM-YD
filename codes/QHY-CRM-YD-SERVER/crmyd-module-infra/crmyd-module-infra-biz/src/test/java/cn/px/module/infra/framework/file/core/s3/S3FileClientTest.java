package cn.px.module.infra.framework.file.core.s3;

import cn.hutool.core.io.resource.ResourceUtil;
import cn.hutool.core.util.IdUtil;
import cn.px.framework.common.util.validation.ValidationUtils;
import cn.px.module.infra.framework.file.core.client.s3.S3FileClient;
import cn.px.module.infra.framework.file.core.client.s3.S3FileClientConfig;
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.crmyd.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.crmyd.iocoder.cn
        // 默认上海的 endpoint
