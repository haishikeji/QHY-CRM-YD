package cn.px.module.infra.service.job;

import cn.hutool.extra.spring.SpringUtil;
import cn.px.framework.common.pojo.PageResult;
import cn.px.framework.common.util.object.BeanUtils;
import cn.px.framework.quartz.core.handler.JobHandler;
import cn.px.framework.quartz.core.scheduler.SchedulerManager;
import cn.px.framework.quartz.core.util.CronUtils;
import cn.px.module.infra.controller.admin.job.vo.job.JobPageReqVO;
import cn.px.module.infra.controller.admin.job.vo.job.JobSaveReqVO;
import cn.px.module.infra.dal.dataobject.job.JobDO;
import cn.px.module.infra.dal.mysql.job.JobMapper;
import cn.px.module.infra.enums.job.JobStatusEnum;
...
import static cn.px.framework.common.util.collection.CollectionUtils.containsAny;
import static cn.px.module.infra.enums.ErrorCodeConstants.*;
